...
export const FocusOverlay: React.FC<Props> = ({ onFocus }) => {
  return (
    <div
      ...
      style={{ background: 'rgba(26, 26, 46, 0.85)', backdropFilter: 'blur(2px)' }}
      onClick={onFocus}
    >
      <svg width="40" height="40" viewBox="0 0 80 80" fill="none" className="mb-3 opacity-60">
        <circle cx="40" cy="38" r="22" fill="none" stroke="#f7a8b8" strokeWidth="1.5"/>
        <path d="M18 22 L12 8 L28 18 Z" fill="none" stroke="#f7a8b8" strokeWidth="1.5"/>
        <path d="M62 22 L68 8 L52 18 Z" fill="none" stroke="#f7a8b8" strokeWidth="1.5"/>
